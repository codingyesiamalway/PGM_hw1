...
for i = 1 : size(assignments, 1)
    assignmentBAtIndexB = IndexToAssignment(indxB(i, :), B.card);
    original = GetValueOfAssignment(B, assignmentBAtIndexB);
    aval = GetValueOfAssignment(A, assignments(i, :));
    B = SetValueOfAssignment(B, assignmentBAtIndexB, original + aval);
end
